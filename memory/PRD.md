...
## Backlog (P0/P1/P2)
- P1: Подключить SMTP-уведомления в backend `.env` (EMAIL_HOST/USER/PASSWORD/...) — пока письма
  не отправляются, но заявки сохраняются в MongoDB
- P1: Добавить блок «Аренда» на главной (в Equipment/Services section)
  с прямой ссылкой на новую страницу
- P2: Sitemap.xml дополнить новым маршрутом `/arenda-kyocera-m2035dn`
